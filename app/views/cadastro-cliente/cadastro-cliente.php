...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
        ...
        try {
            ...
            $checkSql = "SELECT id FROM cliente WHERE email = :email LIMIT 1";
            ...
            if ($checkStmt->fetch()) {
                ...
                $stmtCliente->execute([
                    ...
                    ':email' => $email,
                    ':cartao_credito' => $cartao_credito !== '' ? $cartao_credito : null,
        ...
        <div class="cadastro-card">
            <div class="card-top">
                ...
                <div class="switch-type">
                    Quer vender produtos? <a href="../cadastro-fornecedor/cadastro-fornecedor.php">Cadastre-se como fornecedor</a>
                </div>
            </div>
